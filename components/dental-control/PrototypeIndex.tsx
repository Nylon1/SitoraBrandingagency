...
import { Activity, ArrowRight, BarChart3, BrainCircuit, Building2, Calculator, ClipboardCheck, Flag, Gauge, Layers3, MessageCircle, Network, PlayCircle, Rocket, ShieldCheck, Sparkles, UserRoundSearch } from "lucide-react";
...
const routes = [
  ...
  { href: "/tools/dental-control/command", title: "Executive Command Centre", copy: "Morning huddle, branch targets, month-end forecast, interventions and do-nothing downside in one operating view.", icon: Gauge, tag: "Operate" },
  { href: "/tools/dental-control/live", title: "Live Operations", copy: "Simulated real-time events flowing from source systems through rules, pattern detection and workflow actions.", icon: Activity, tag: "Live" },
  { href: "/tools/dental-control/recovery", title: "Patient Recovery Engine", copy: "Match unused chair capacity to legitimate patient demand, prepare outreach and simulate human-approved refill workflows.", icon: MessageCircle, tag: "Execution" },
  ...
  { href: "/tools/dental-control/copilot", title: "Ask Sitora Copilot", copy: "Evidence-grounded executive conversation, follow-up questions and what-if scenario analysis.", icon: BrainCircuit, tag: "AI" },
  ...
  { href: "/tools/dental-control/commercial", title: "Commercial & ROI Case", copy: "Assumption-controlled ROI, branch contribution economics and illustrative SaaS packaging.", icon: Calculator, tag: "Commercial" },
  { href: "/tools/dental-control/pilot", title: "Pilot Proposal Builder", copy: "Configure branches, modules, duration and measurable success criteria for a design-partner pilot.", icon: Flag, tag: "Pilot" },
  { href: "/tools/dental-control/investor", title: "Investor Economics", copy: "Interactive ARR scenarios, land-and-expand logic, enterprise sales motion and moat narrative.", icon: Rocket, tag: "Investor" },
  { href: "/tools/dental-control/trust", title: "Trust Centre", copy: "Source freshness, KPI reconciliation, lineage, auditability and production security model.", icon: ShieldCheck, tag: "Trust" },
...
export function PrototypeIndex() {
  return <div className="min-h-screen bg-[#071310] text-white">
    ...
    <main className="relative mx-auto max-w-[1320px] px-4 py-10 md:px-7 md:py-14">
      ...
      <div className="mt-7 rounded-3xl border border-[#c49a53]/14 bg-[#c49a53]/[0.035] p-5"><div className="text-[10px] font-semibold uppercase tracking-[0.15em] text-[#e3c183]">Recommended VC review order</div><div className="mt-3 text-[11px] leading-6 text-white/45">Control Tower → Executive Command Centre → Live Operations → Patient Recovery Engine → VC Demo → Ask Sitora Copilot → Jeddah Branch → Branch Comparison → Interactive Action Centre → Boardroom → Commercial & ROI → Pilot Builder → Investor Economics → Trust Centre → Platform → Pilot Onboarding.</div></div>
    </main>
  </div>;
}
