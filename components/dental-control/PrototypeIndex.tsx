...
import { ArrowRight, BarChart3, BrainCircuit, Building2, Calculator, ClipboardCheck, Flag, Layers3, Network, PlayCircle, Rocket, ShieldCheck, Sparkles, UserRoundSearch } from "lucide-react";
...
export function PrototypeIndex() {
  return <div className="min-h-screen bg-[#071310] text-white">
    ...
    <main className="relative mx-auto max-w-[1320px] px-4 py-10 md:px-7 md:py-14">
      ...
      <div className="mt-7 rounded-3xl border border-[#c49a53]/14 bg-[#c49a53]/[0.035] p-5"><div className="text-[10px] font-semibold uppercase tracking-[0.15em] text-[#e3c183]">Recommended VC review order</div><div className="mt-3 text-[11px] leading-6 text-white/45">Control Tower → VC Demo → Ask Sitora Copilot → Jeddah Branch → Branch Comparison → Interactive Action Centre → Boardroom → Commercial & ROI → Pilot Builder → Investor Economics → Trust Centre → Platform → Pilot Onboarding.</div></div>
    </main>
  </div>;
}
