...
export const metadata: Metadata = {
  title: "Dental Intelligence Platform | Sitora Dental Control",
  description:
    "Explore Sitora Dental Control, an operating intelligence prototype for dental groups covering chair utilisation, treatment leakage, claims risk, governance and evidence-grounded AI.",
    ...
    <main className="bg-[#071310] text-white">
      <section className="border-b border-white/[0.06]">
        <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
          <div className="text-xs font-semibold uppercase tracking-[0.16em] text-[#86d4ca]">
            Dental operating intelligence
          </div>
          ...
          <div className="mt-6 text-xs text-white/35">
            Prototype · synthetic data · no live clinical, payer or production-system connection
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-20">
        <div className="max-w-3xl">
          <div className="text-xs font-semibold uppercase tracking-[0.16em] text-[#73cabf]">
            The thesis
          </div>
      ...
      <section className="border-y border-white/[0.06] bg-white/[0.02]">
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-16 md:px-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-[#2aa89a]/20 bg-[#0d2822] p-6">
            ...
            <div className="mt-4 text-lg font-semibold">“Why is this branch underperforming?”</div>
            ...
            <Link
              href="/tools/dental-control/copilot"
              className="mt-5 inline-flex text-sm font-semibold text-[#7fd0c5]"
            >
              Try Ask Sitora →
            </Link>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-20">
        <div className="rounded-3xl border border-[#c49a53]/20 bg-[#c49a53]/[0.045] p-7 md:p-10">
          <div className="text-xs font-semibold uppercase tracking-[0.16em] text-[#e2c184]">
            Research-led product development
          </div>
          <h2 className="mt-3 max-w-3xl text-3xl font-semibold tracking-[-0.035em]">
            The next question is bigger than analytics: can the full dental episode stay connected across systems?
          </h2>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              href="/research"
              className="inline-flex rounded-xl border border-[#c49a53]/25 bg-[#c49a53]/10 px-4 py-2.5 text-sm font-semibold text-[#e8c98f]"
            >
              Explore Sitora research
            </Link>
            <Link
              href="/research/saudi-dental-software-landscape-2026"
              className="inline-flex rounded-xl border border-white/10 bg-white/[0.03] px-4 py-2.5 text-sm font-medium text-white/60"
            >
              Read the Saudi market case study
            </Link>
          </div>
        </div>
      </section>
