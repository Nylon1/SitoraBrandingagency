...
export const metadata: Metadata = {
  title: "AI as the NHS Front Door | Sitora Research",
  description:
  ...
  alternates: {
    canonical: "/research/ai-as-the-nhs-front-door",
  },
  robots: {
    index: true,
    follow: true,
    ...
    <main className="min-h-screen bg-[#07100f] text-white">
      <section className="border-b border-white/[0.07]">
        <div className="mx-auto max-w-5xl px-5 py-20 md:px-8 md:py-28">
          <Link
            href="/research"
            className="text-sm font-medium text-[#7acdc3]"
          >
            ← Sitora Research
          </Link>
      ...
      <section className="mx-auto max-w-5xl px-5 py-14 md:px-8 md:py-20">
        ...
        <section className="mt-14 border-t border-white/[0.07] pt-12">
          ...
          <p className="mt-5 max-w-3xl text-sm leading-7 text-white/52">
            The report proposes six public-facing assurance questions:
            clinical safety validation, independent AI audit, human escalation,
            defined accountability, patient transparency and continuous
